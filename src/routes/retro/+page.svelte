...
<body class="gradient-bg">
	...
	<h1 class="pl-24 text-2xl font-medium">
	...
	<h1 class="pl-24 pt-8 text-7xl font-bold text-outline">The Games</h1>

	<div class="grid grid-cols-1 mx-72 my-8 text-shadow">
		<!-- Retro Tennis 1 -->
		...
		<div class="flex project-card flex-col items-start gap-3 p-5 m-6 z-1 h-96 shadow-lg border-2 border-border_t hover:border-border_t_h rounded-xl bg-[#3F3F3F4F]">
			<div class="w-full flex items-center justify-center h-full">
				<img src="./assets/retro/rt2banner.png" alt="Retro Tennis 2 Logo" class="overflow-hidden mx-auto h-full rounded-xl" />
		...
		<div class="flex project-card flex-col items-start gap-3 p-5 m-6 z-1 h-96 shadow-lg border-2 border-border_t hover:border-border_t_h rounded-xl bg-[#3F3F3F4F]">
			<div class="w-full flex items-center justify-center h-full">
				<img src="./assets/retro/rtdbanner.png" alt="Retro Tennis Deluxe Logo" class="overflow-hidden mx-auto h-full rounded-xl" />
				<div class="w-1/2 pl-4">
